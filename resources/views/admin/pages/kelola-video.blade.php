		...
		<div class="col-md-4">
			<div class="card">
				<div class="card-header bg-white border-0 text-center font-weight-bold">
					<i class="fa fa-plus-square"></i> Tambah Video
				</div>
				<div class="card-body">
					<form id="form-create">
						...
						<div class="form-group">
							...
							<input class="form-control" type="url" name="video" required id="video" placeholder="URL Video Youtube">
						</div>
...
@push('js')
    ...
    <script type="module" src="{{asset('js/pages/kelola_video.js')}}" type="text/javascript"></script>
@endpush