                ...
                <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
                        <div class="header__info">
                            <div class="logo">
                                <a href="index.html" class="logo-image"><img src="{{asset('logo_text.svg')}}" alt="logo"></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="header__search">
                            <form action="#">
                                <div class="header__search-box">
                                    <input class="search-input" type="text" placeholder="Cari plakat..">
            ...
            <div class="row g-0 align-items-center">
                <div class="col-lg-3">
                    <div class="cat__menu-wrapper side-border d-none d-lg-block">
                        <div class="cat-toggle">
                            <button type="button" class="cat-toggle-btn cat-toggle-btn-1"><i class="fal fa-bars"></i> Macam Macam Produk</button>
                            <div class="cat__menu">
                ...
                <div class="col-lg-3 col-md-6 col-9">
                    <div class="shopeing-text text-sm-end">
                        <p>Telah berpengalaman & dipercaya selama <strong>10 Tahun+</strong></p>
                    </div>
                </div>
            </div>
        </div>
